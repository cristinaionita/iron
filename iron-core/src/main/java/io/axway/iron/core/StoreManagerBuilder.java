...
public interface StoreManagerBuilder {
    ...
    StoreManagerBuilder withMigration(int desiredVersion, Collection<IronStoreMigrationProcess> processes, Function<SerializableSnapshot, Long> versionDetector);
